...
const About = () => {
  ...
  return (
    ...
    >
      <motion.h2
        className="text-4xl md:text-5xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-[#7357ff] to-[#fcacff]"
      ...
      >
        <button
          ...
          className="px-6 py-3 text-white font-semibold rounded-full bg-gradient-to-r from-[#7357ff] to-[#fcacff] hover:opacity-90 transition-all duration-300"
        >
